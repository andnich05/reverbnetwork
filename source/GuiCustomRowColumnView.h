...
namespace VSTGUI {
	...
	public:
		...
		// Set the width of the frame to paint around the view (frame is painted inside the view so beware of collisions with content!)
		virtual inline void setFrameWidth(const int& width = 0) { frameWidth = width; }
		// Set the rounding of the frame to paint around the view
