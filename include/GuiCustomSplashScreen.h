...
class GuiCustomSplashScreen : public VSTGUI::CSplashScreen {
public:
	GuiCustomSplashScreen(const VSTGUI::CRect& size, VSTGUI::IControlListener* listener, int32_t tag, VSTGUI::CView* splashView);
