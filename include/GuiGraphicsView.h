...
{
public:
	GuiGraphicsView(const VSTGUI::CRect& size, const int& numberOfModules, CBaseObject* editor);
	~GuiGraphicsView();
	...
	virtual void setModulePosition(const int& moduleId, const VSTGUI::CPoint& position);
	// Get module position
	virtual VSTGUI::CPoint getModulePosition(const int& moduleId) const;
	// Change Vst input position
	virtual void setVstInputPosition(const int& vstInput, const VSTGUI::CPoint& position);
	// Get Vst input position
	virtual VSTGUI::CPoint getVstInputPosition(const int& vstInput) const;
	// Change Vst output position
	virtual void setVstOutputPosition(const int& vstOutput, const VSTGUI::CPoint& position);
	// Get Vst input position
	virtual VSTGUI::CPoint getVstOutputPosition(const int& vstOutput) const;
	...
	virtual VSTGUI::CMessageResult notify(CBaseObject* sender, VSTGUI::IdStringPtr message) override;
...
private:
	...
	// Redraw everything
	virtual void redraw(VSTGUI::CDrawContext* pContext);
	// Draw connections
	virtual void drawModuleConnections(VSTGUI::CDrawContext* pContext);
