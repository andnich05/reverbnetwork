...
GuiCustomTextEdit::GuiCustomTextEdit(const VSTGUI::CRect& size, VSTGUI::IControlListener* listener, int32_t tag, VSTGUI::UTF8StringPtr txt, VSTGUI::CBitmap* background, const int32_t style)
...
void GuiCustomTextEdit::looseFocus()
{
	...
	setText(VSTGUI::UTF8String(stringToTruncate+currentString));
}
